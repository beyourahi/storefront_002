...
function FreeShippingProgress({cart, shippingConfig, isPage = true}: FreeShippingProgressProps) {
    ...
    const threshold = shippingConfig.freeShippingThreshold ?? 5000;
...
function CartCheckoutActions({
    ...
    const baseStyles = cn(
        "w-full inline-flex items-center justify-between rounded-full border-2 px-3 sm:px-4 min-h-11 text-base sm:text-lg font-medium transition-colors",

...
export type CustomerDashboardQuery = {
    customer: {
        orders: {
            nodes: Array<
                Pick<CustomerAccountAPI.Order, "id" | "name" | "number" | "processedAt" | "financialStatus"> & {
                    fulfillments: {nodes: Array<Pick<CustomerAccountAPI.Fulfillment, "status">>};
                    totalPrice: Pick<CustomerAccountAPI.MoneyV2, "amount" | "currencyCode">;
                    lineItems: {
                        nodes: Array<
...
> & {
    ...
    image?: CustomerAccountAPI.Maybe<Pick<CustomerAccountAPI.Image, "url" | "altText" | "width" | "height">>;
};
...
> & {
    lineItems: {
        nodes: Array<
            Pick<CustomerAccountAPI.LineItem, "id" | "name" | "title" | "productId" | "variantId" | "quantity"> & {
                price?: CustomerAccountAPI.Maybe<Pick<CustomerAccountAPI.MoneyV2, "amount" | "currencyCode">>;
                image?: CustomerAccountAPI.Maybe<
                    Pick<CustomerAccountAPI.Image, "url" | "altText" | "width" | "height">
                >;
...
> & {
    ...
    returns: {
        nodes: Array<
            Pick<CustomerAccountAPI.Return, "id" | "name" | "status" | "createdAt"> & {
                returnLineItems: {
                    nodes: Array<
                        | (Pick<CustomerAccountAPI.ReturnLineItem, "id" | "quantity" | "returnReason"> & {
                              lineItem: Pick<CustomerAccountAPI.LineItem, "id" | "title" | "variantTitle"> & {
                                  image?: CustomerAccountAPI.Maybe<
                                      Pick<CustomerAccountAPI.Image, "altText" | "url" | "width" | "height">
                                  >;
                              };
                          })
                        | (Pick<CustomerAccountAPI.UnverifiedReturnLineItem, "id" | "quantity" | "returnReason"> & {
                              lineItem: Pick<CustomerAccountAPI.LineItem, "id" | "title" | "variantTitle"> & {
                                  image?: CustomerAccountAPI.Maybe<
                                      Pick<CustomerAccountAPI.Image, "altText" | "url" | "width" | "height">
                                  >;
...
> & {
    ...
    lineItems: {
        nodes: Array<
            Pick<
                CustomerAccountAPI.LineItem,
                "id" | "title" | "name" | "quantity" | "productId" | "variantId" | "variantTitle"
            > & {
                price?: CustomerAccountAPI.Maybe<Pick<CustomerAccountAPI.MoneyV2, "amount" | "currencyCode">>;
                image?: CustomerAccountAPI.Maybe<
                    Pick<CustomerAccountAPI.Image, "url" | "altText" | "width" | "height">
...
export type CustomerOrdersListFragment = {
    orders: {
        nodes: Array<
            Pick<CustomerAccountAPI.Order, "id" | "name" | "number" | "processedAt" | "fulfillmentStatus"> & {
                fulfillments: {nodes: Array<Pick<CustomerAccountAPI.Fulfillment, "status">>};
                totalPrice: Pick<CustomerAccountAPI.MoneyV2, "amount" | "currencyCode">;
                lineItems: {
                    nodes: Array<
...
export type ReturnLineItemFragment = Pick<CustomerAccountAPI.ReturnLineItem, "id" | "quantity" | "returnReason"> & {
    lineItem: Pick<CustomerAccountAPI.LineItem, "id" | "title" | "variantTitle"> & {
        image?: CustomerAccountAPI.Maybe<Pick<CustomerAccountAPI.Image, "altText" | "url" | "width" | "height">>;
    };
};

export type ReturnInfoFragment = Pick<CustomerAccountAPI.Return, "id" | "name" | "status" | "createdAt"> & {
    returnLineItems: {
        nodes: Array<
            Pick<CustomerAccountAPI.ReturnLineItem, "id" | "quantity" | "returnReason"> & {
                lineItem: Pick<CustomerAccountAPI.LineItem, "id" | "title" | "variantTitle"> & {
...
export type OrderWithReturnsFragment = Pick<CustomerAccountAPI.Order, "id" | "name" | "number" | "processedAt"> & {
    returns: {
        nodes: Array<
            Pick<CustomerAccountAPI.Return, "id" | "name" | "status" | "createdAt"> & {
                returnLineItems: {
...
export type CustomerReturnsQueryVariables = CustomerAccountAPI.Exact<{
    first?: CustomerAccountAPI.InputMaybe<CustomerAccountAPI.Scalars["Int"]["input"]>;
    after?: CustomerAccountAPI.InputMaybe<CustomerAccountAPI.Scalars["String"]["input"]>;
    language?: CustomerAccountAPI.InputMaybe<CustomerAccountAPI.LanguageCode>;
}>;
...
export type CustomerReturnsQuery = {
    customer: {
        orders: {
            nodes: Array<
                Pick<CustomerAccountAPI.Order, "id" | "name" | "number" | "processedAt"> & {
                    returns: {
                        nodes: Array<
                            Pick<CustomerAccountAPI.Return, "id" | "name" | "status" | "createdAt"> & {
                                returnLineItems: {
...
export type CustomerEmailMarketingSubscribeMutationVariables = CustomerAccountAPI.Exact<{
    language?: CustomerAccountAPI.InputMaybe<CustomerAccountAPI.LanguageCode>;
}>;
...
export type CustomerEmailMarketingSubscribeMutation = {
    customerEmailMarketingSubscribe?: CustomerAccountAPI.Maybe<{
        ...
        >;
        userErrors: Array<
            Pick<CustomerAccountAPI.UserErrorsCustomerEmailMarketingUserErrors, "code" | "field" | "message">
        >;
    }>;
};

export type CustomerEmailMarketingUnsubscribeMutationVariables = CustomerAccountAPI.Exact<{
    language?: CustomerAccountAPI.InputMaybe<CustomerAccountAPI.LanguageCode>;
}>;
...
export type OrderRequestReturnMutationVariables = CustomerAccountAPI.Exact<{
    orderId: CustomerAccountAPI.Scalars["ID"]["input"];
    requestedLineItems: Array<CustomerAccountAPI.RequestedLineItemInput> | CustomerAccountAPI.RequestedLineItemInput;
    language?: CustomerAccountAPI.InputMaybe<CustomerAccountAPI.LanguageCode>;
}>;
...
export type OrderRequestReturnMutation = {
    orderRequestReturn?: CustomerAccountAPI.Maybe<{
        ...
        >;
        userErrors: Array<Pick<CustomerAccountAPI.ReturnUserError, "code" | "field" | "message">>;
    }>;
};
        ...
        orders: {
            nodes: Array<
                Pick<CustomerAccountAPI.Order, "id" | "fulfillmentStatus"> & {
                    returnInformation: {
                        returnableLineItems: {nodes: Array<Pick<CustomerAccountAPI.ReturnableLineItem, "quantity">>};
                        nonReturnableSummary?: CustomerAccountAPI.Maybe<
                            Pick<CustomerAccountAPI.OrderNonReturnableSummary, "nonReturnableReasons">
                        >;
                    };
...
export type StoreCreditAccountFragment = Pick<CustomerAccountAPI.StoreCreditAccount, "id"> & {
...
> & {
    ...
    balanceAfterTransaction: Pick<CustomerAccountAPI.MoneyV2, "amount" | "currencyCode">;
...
export type CustomerStoreCreditQueryVariables = CustomerAccountAPI.Exact<{
    first?: CustomerAccountAPI.InputMaybe<CustomerAccountAPI.Scalars["Int"]["input"]>;
    transactionsFirst?: CustomerAccountAPI.InputMaybe<CustomerAccountAPI.Scalars["Int"]["input"]>;
    language?: CustomerAccountAPI.InputMaybe<CustomerAccountAPI.LanguageCode>;
}>;
                ...
                Pick<CustomerAccountAPI.StoreCreditAccount, "id"> & {
                    transactions: {
                        nodes: Array<
                            ...
                            | (Pick<CustomerAccountAPI.StoreCreditAccountDebitTransaction, "id" | "createdAt"> & {
                                  amount: Pick<CustomerAccountAPI.MoneyV2, "amount" | "currencyCode">;
                                  balanceAfterTransaction: Pick<CustomerAccountAPI.MoneyV2, "amount" | "currencyCode">;
                              })
                        >;
...
export type CustomerStoreCreditBalanceQueryVariables = CustomerAccountAPI.Exact<{
    language?: CustomerAccountAPI.InputMaybe<CustomerAccountAPI.LanguageCode>;
}>;
...
export type SubscriptionContractPauseMutationVariables = CustomerAccountAPI.Exact<{
...
export type SubscriptionContractPauseMutation = {
    subscriptionContractPause?: CustomerAccountAPI.Maybe<{
        contract?: CustomerAccountAPI.Maybe<
            Pick<CustomerAccountAPI.SubscriptionContract, "id" | "status" | "updatedAt">
        >;
        userErrors: Array<
            Pick<CustomerAccountAPI.SubscriptionContractStatusUpdateUserError, "code" | "field" | "message">
        >;
    }>;
};

export type SubscriptionContractCancelMutationVariables = CustomerAccountAPI.Exact<{
    subscriptionContractId: CustomerAccountAPI.Scalars["ID"]["input"];
    language?: CustomerAccountAPI.InputMaybe<CustomerAccountAPI.LanguageCode>;
}>;
...
export type SubscriptionContractActivateMutationVariables = CustomerAccountAPI.Exact<{
    subscriptionContractId: CustomerAccountAPI.Scalars["ID"]["input"];
    language?: CustomerAccountAPI.InputMaybe<CustomerAccountAPI.LanguageCode>;
}>;
...
export type SubscriptionContractActivateMutation = {
    subscriptionContractActivate?: CustomerAccountAPI.Maybe<{
        contract?: CustomerAccountAPI.Maybe<
            Pick<CustomerAccountAPI.SubscriptionContract, "id" | "status" | "updatedAt" | "nextBillingDate">
        >;
        userErrors: Array<
            Pick<CustomerAccountAPI.SubscriptionContractStatusUpdateUserError, "code" | "field" | "message">
        >;
...
export type SubscriptionBillingCycleSkipMutationVariables = CustomerAccountAPI.Exact<{
...
export type SubscriptionBillingCycleSkipMutation = {
    subscriptionBillingCycleSkip?: CustomerAccountAPI.Maybe<{
        billingCycle?: CustomerAccountAPI.Maybe<
            ...
            >
        >;
        userErrors: Array<Pick<CustomerAccountAPI.SubscriptionBillingCycleSkipUserError, "code" | "field" | "message">>;
    }>;
};

export type SubscriptionBillingCycleUnskipMutationVariables = CustomerAccountAPI.Exact<{
    billingCycleInput: CustomerAccountAPI.SubscriptionBillingCycleInput;
    language?: CustomerAccountAPI.InputMaybe<CustomerAccountAPI.LanguageCode>;
}>;
...
export type SubscriptionBillingCycleUnskipMutation = {
    subscriptionBillingCycleUnskip?: CustomerAccountAPI.Maybe<{
        ...
        >;
        userErrors: Array<
            Pick<CustomerAccountAPI.SubscriptionBillingCycleUnskipUserError, "code" | "field" | "message">
        >;
    }>;
};
...
> & {
    ...
    lineDiscountedPrice: Pick<CustomerAccountAPI.MoneyV2, "amount" | "currencyCode">;
    image?: CustomerAccountAPI.Maybe<Pick<CustomerAccountAPI.Image, "altText" | "url" | "width" | "height">>;
};
...
> & {intervalCount?: CustomerAccountAPI.Maybe<Pick<CustomerAccountAPI.Count, "count">>};

export type SubscriptionDeliveryPolicyFragment = Pick<CustomerAccountAPI.SubscriptionDeliveryPolicy, "interval"> & {
    intervalCount?: CustomerAccountAPI.Maybe<Pick<CustomerAccountAPI.Count, "count">>;
};

export type SubscriptionBillingCycleFragment = Pick<
    CustomerAccountAPI.SubscriptionBillingCycle,
    "cycleIndex" | "cycleStartAt" | "cycleEndAt" | "billingAttemptExpectedDate" | "skipped" | "status"
>;
...
> & {
    ...
    billingPolicy: Pick<CustomerAccountAPI.SubscriptionBillingPolicy, "interval" | "minCycles" | "maxCycles"> & {
        intervalCount?: CustomerAccountAPI.Maybe<Pick<CustomerAccountAPI.Count, "count">>;
    };
    deliveryPolicy: Pick<CustomerAccountAPI.SubscriptionDeliveryPolicy, "interval"> & {
        intervalCount?: CustomerAccountAPI.Maybe<Pick<CustomerAccountAPI.Count, "count">>;
    };
    lines: {
        nodes: Array<
            Pick<CustomerAccountAPI.SubscriptionLine, "id" | "name" | "title" | "variantTitle" | "quantity" | "sku"> & {
                currentPrice: Pick<CustomerAccountAPI.MoneyV2, "amount" | "currencyCode">;
                lineDiscountedPrice: Pick<CustomerAccountAPI.MoneyV2, "amount" | "currencyCode">;
                image?: CustomerAccountAPI.Maybe<
                    Pick<CustomerAccountAPI.Image, "altText" | "url" | "width" | "height">
...
export type CustomerSubscriptionsQueryVariables = CustomerAccountAPI.Exact<{
    ...
    after?: CustomerAccountAPI.InputMaybe<CustomerAccountAPI.Scalars["String"]["input"]>;
    last?: CustomerAccountAPI.InputMaybe<CustomerAccountAPI.Scalars["Int"]["input"]>;
    before?: CustomerAccountAPI.InputMaybe<CustomerAccountAPI.Scalars["String"]["input"]>;
    reverse?: CustomerAccountAPI.InputMaybe<CustomerAccountAPI.Scalars["Boolean"]["input"]>;
    language?: CustomerAccountAPI.InputMaybe<CustomerAccountAPI.LanguageCode>;
}>;
    ...
    customer: {
        subscriptionContracts: {
            ...
            nodes: Array<
                ...
                > & {
                    billingPolicy: Pick<CustomerAccountAPI.SubscriptionBillingPolicy, "interval"> & {
                        intervalCount?: CustomerAccountAPI.Maybe<Pick<CustomerAccountAPI.Count, "count">>;
                    };
                    lines: {
                        nodes: Array<
                            Pick<CustomerAccountAPI.SubscriptionLine, "id" | "name" | "title" | "quantity"> & {
                                currentPrice: Pick<CustomerAccountAPI.MoneyV2, "amount" | "currencyCode">;
                                image?: CustomerAccountAPI.Maybe<
                                    Pick<CustomerAccountAPI.Image, "altText" | "url" | "width" | "height">
                                >;
    ...
    customer: {
        subscriptionContract?: CustomerAccountAPI.Maybe<
            ...
            > & {
                orders: {
                    nodes: Array<
                        Pick<CustomerAccountAPI.Order, "id" | "name" | "processedAt" | "fulfillmentStatus"> & {
                            totalPrice: Pick<CustomerAccountAPI.MoneyV2, "amount" | "currencyCode">;
                        }
                    >;
                };
                originOrder?: CustomerAccountAPI.Maybe<Pick<CustomerAccountAPI.Order, "id" | "name" | "processedAt">>;
                deliveryPrice: Pick<CustomerAccountAPI.MoneyV2, "amount" | "currencyCode">;
                billingPolicy: Pick<
                    CustomerAccountAPI.SubscriptionBillingPolicy,
                    "interval" | "minCycles" | "maxCycles"
